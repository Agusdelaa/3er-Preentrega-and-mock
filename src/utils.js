...
function fakerProducts() {
    return {
        ...
        thumbnails: [faker.image.url(), faker.image.url(),faker.image.url(),faker.image.url()]
    };
}

export { __dirname, createHash, isValidPassword, generateToken, validateToken, fakerProducts };